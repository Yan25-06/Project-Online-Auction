...
export const ProductService = {
  ...
  search: async (q, categoryId, sortBy, page, limit) => {
    const response = await apiClient.get("/products/search", {
      params: { q, categoryId, sortBy, page, limit },
    });
    return response.data;
  },
  ...
  getMostBids: async (limit = 5) => {
    const response = await apiClient.get("/products/most-bids", {
      params: { limit },
    });
    return response.data;
  },
  ...
  getHighestPrice: async (limit = 5) => {
    const response = await apiClient.get("/products/highest-price", {
      params: { limit },
    });
    return response.data;
  },
  ...
  appendDescription: async (id, description) => {
    const response = await apiClient.post(`/products/${id}/description`, {
      description,
    });
    return response.data;
  },
  ...
  endAuction: async (id) => {
    const response = await apiClient.post(`/products/${id}/end-auction`);
    return response.data;
  },
...
export const BidService = {
  ...
  getHistory: async (productId, page = 1, limit = 50) => {
    const response = await apiClient.get(`/bids/product/${productId}/history`, {
      params: { page, limit },
    });
    return response.data;
  },
  ...
  findByBidder: async (bidderId, page = 1, limit = 20) => {
    const response = await apiClient.get(`/bids/bidder/${bidderId}`, {
      params: { page, limit },
    });
    return response.data;
  },
  ...
  getWinningBids: async (bidderId, page = 1, limit = 20) => {
    const response = await apiClient.get(`/bids/winning/${bidderId}`, {
      params: { page, limit },
    });
    return response.data;
  },
...
export const WatchlistService = {
  ...
  findByUser: async (userId, page = 1, limit = 20) => {
    const response = await apiClient.get(`/watchlists/user/${userId}`, {
      params: { page, limit },
    });
    return response.data;
  },
...
export const OrderService = {
  ...
  submitPaymentAndAddress: async (id, shippingAddress, paymentProofUrl) => {
    const response = await apiClient.post(`/orders/${id}/payment-address`, {
      shippingAddress,
      paymentProofUrl,
    });
    return response.data;
  ...
  confirmPaymentAndShipping: async (id, shippingProofUrl) => {
    const response = await apiClient.post(`/orders/${id}/confirm-shipping`, {
      shippingProofUrl,
    });
    return response.data;
  },
  ...
  submitRating: async (id, score, feedback) => {
    const response = await apiClient.post(`/orders/${id}/rating`, {
      score,
      feedback,
    });
    return response.data;
  ...
  updatePaymentProof: async (id, proofUrl) => {
    const response = await apiClient.patch(`/orders/${id}/payment-proof`, {
      proofUrl,
    });
    return response.data;
  },
  ...
  updateShippingProof: async (id, proofUrl) => {
    const response = await apiClient.patch(`/orders/${id}/shipping-proof`, {
      proofUrl,
    });
    return response.data;
  },
  ...
  // Seller cancels transaction with auto negative rating
  cancelBySeller: async (id, reason) => {
    const response = await apiClient.post(`/orders/${id}/cancel-seller`, {
      reason,
    });
    return response.data;
  },
  ...
  findByWinner: async (winnerId, page = 1, limit = 20) => {
    const response = await apiClient.get(`/orders/winner/${winnerId}`, {
      params: { page, limit },
    });
    return response.data;
  },
...
export const QuestionService = {
  ...
  findByProduct: async (productId, page = 1, limit = 20) => {
    const response = await apiClient.get(`/questions/product/${productId}`, {
      params: { page, limit },
    });
    return response.data;
  },
...
export const RatingService = {
  ...
  findByOrderAndRater: async (orderId, raterId) => {
    const response = await apiClient.get(
      `/ratings/order/${orderId}/rater/${raterId}`
    );
    return response.data;
  },
};
...
export const BlockedBidderService = {
  ...
  unblock: async (productId, bidderId) => {
    const response = await apiClient.delete(
      `/blocked-bidders/product/${productId}/bidder/${bidderId}`
    );
    return response.data;
  },
  ...
  isBlocked: async (productId, bidderId) => {
    const response = await apiClient.get(
      `/blocked-bidders/${productId}/${bidderId}`
    );
    return response.data;
  },
  ...
  findByProduct: async (productId, page = 1, limit = 20) => {
    const response = await apiClient.get(
      `/blocked-bidders/product/${productId}`,
      { params: { page, limit } }
    );
    return response.data;
  },
