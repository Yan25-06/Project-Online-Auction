        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-gray-100 border-b">
              ...
              <th className="p-3">Giá tối đa của bạn</th>
              ...
              <>
                {bids.map((bid) => (
                  <tr key={bid.id} className="border-b">
                    ...
                    <td className="p-3 text-blue-600 font-bold">{formatCurrency(bid.max_bid_amount || bid.bid_amount)}</td>
                    <td className="p-3">
                      {bid.max_bid_amount >= bid.product.current_price ? (
